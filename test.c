...
void joueur_ordinateur(int generated, SDL_Window* window, SDL_Surface* screenSurface, SDL_Surface* play, SDL_Event event, int* one_player)
{
    ...
    int test = 0; //la variable test nous permet de voir si la valeur entr� et integre ou non
    test = joueur_ordinateur_aleatoir(generated, data, interdit); //test=1 si une piere est pos� 11 si pass
    calcul_liberte();
...
void joueur_joueur(int abscice, int ordonnee, SDL_Window* window, SDL_Surface* screenSurface, SDL_Surface* play, SDL_Event event, int* one_player)
{
    ...
    zone();
    int test = 0; //la variable test nous permet de voir si la valeur entr� et integre ou non
    test = saisie(abscice, ordonnee, data, interdit); //test=1 si une piere est pos� 11 si pass
    if (test)
    {
        if (player == 0)
        {
